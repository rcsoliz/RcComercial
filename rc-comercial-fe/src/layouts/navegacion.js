import { LayoutDashboard, ShoppingCart, Package, Wallet, Truck, Users, Building2, FileText, Settings } from 'lucide-vue-next'
...
export const navegacion = [
  ...
  { to: '/productos', label: 'Productos', labelServicio: 'Servicios', icon: Package, permiso: null },
  ...
  { to: '/proformas', label: 'Proformas', icon: FileText, permiso: Permisos.ProformasCrear, soloEscritorio: true },
